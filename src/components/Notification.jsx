              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium ">{notificationCount === 0 ? 'No deliveries expexted today' : `${notificationCount} Deliveries coming today`}</p>
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-100">
                    {notificationCount === 0 ? null : "Please change status of delivery to notify managment that packages were recieved"}
                    </p>
