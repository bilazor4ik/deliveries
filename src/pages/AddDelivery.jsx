      ...
      <form onSubmit={handleSubmit} className="space-y-8 divide-y divide-gray-200" >
        <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          ...
          <div className="space-y-6 sm:pt-10 sm:space-y-5">
            <div>
              <h3 className="text-lg leading-6 font-medium text-gray-900 text-center">Delivery details</h3>
              
            </div>
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <label htmlFor="vendor" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  Vendor
                </label>
            ...
            <div className="space-y-6 sm:space-y-5">
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <label htmlFor="eta" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  ETA
                </label>
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <label htmlFor="ticket" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  Ticket Number
                </label>
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
